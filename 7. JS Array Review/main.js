/*
Array (mảng) trong js là 1 dạng đặc biệt của object được thiết kế lưu trữ giá trị theo thứ tự và truy cập bằng chỉ số (index), bắng đầu từ 0
*/
//1. Tạo mảng: mảng được tạo bằng cặp dấu ngoặc vuông []
//(ngoài ra còn có cắt tạo bằng constructor)
const traiCay = ["cam", "xoai", "nho", "tao", "cam"];
console.log(typeof traiCay);
console.log(traiCay.map((item) => `${item} !`));
console.log(traiCay);
